      ...
      <article>
        <div style="overflow:scroll; height:500px">
          ...
          <h3>WRAG Assessment</h3>
            <input type="radio" name="WRAGradio" value="red" <?php if ($WRAG == "red") echo 'checked';?>/> Red<br>
            <input type="radio" name="WRAGradio" value="amber" <?php if ($WRAG == "yellow") echo 'checked';?>/> Amber<br>
            <input type="radio" name="WRAGradio" value="green" <?php if ($WRAG == "green") echo 'checked';?>/> Green<br>
            <input type="radio" name="WRAGradio" value="white" <?php if ($WRAG == "white") echo 'checked';?>/> White<br>
          <h3>Topic</h3>
