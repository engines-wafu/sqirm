        ...
        <div style="align-items: flex-start; overflow:scroll; height:136px !important">
          ...
          while ($row = mysqli_fetch_array($result)) {
            echo '<div id="kpiblock">';
			           echo '<table width="95" style="border: none; table-layout:fixed" align=center><tr width="95"><td style="border: none">';	
                echo '<canvas vertical-align=top id="#kpicanvas' . $row['kpiID'] . '" class="kpi"></canvas>';
			           echo '</td></tr><tr><td height="70" style="border: none; background: none">';	
