      ...
      <div align=center style="border:none; padding-bottom:20px">
        <img src="img/logosm.png" width="150px" align="center" />
   		  	<form role="form" method="post" action="" autocomplete="off">
    	  			...
    	  			?>
    	  				<input type="text" name="username" id="username" placeholder="User Name" tabindex="1" size="20">
    	  				<input type="password" name="password" id="password" placeholder="Password" tabindex="3" size="20">
