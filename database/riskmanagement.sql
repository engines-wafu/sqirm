...
CREATE TABLE `actions` (
  ...
  `sqaairID` varchar(8) DEFAULT NULL,
  `actWRAG` enum('white','red','yellow','green') NOT NULL,
  `actIssue` varchar(1722) CHARACTER SET utf8 DEFAULT NULL,
  `actTopic` varchar(33) CHARACTER SET utf8 DEFAULT NULL,
  `actOrigin` varchar(43) CHARACTER SET utf8 DEFAULT NULL,
  `actOwner` varchar(19) CHARACTER SET utf8 DEFAULT NULL,
  `ACTION_PROGRESS` varchar(5989) CHARACTER SET utf8 DEFAULT NULL,
  `actDL` int(11) DEFAULT NULL,
  PRIMARY KEY (`actID`)
...
CREATE TABLE `comments` (
  ...
  `comment` varchar(6000) CHARACTER SET utf8 DEFAULT NULL,
...
-- Dump completed on 2018-05-10  3:38:01
